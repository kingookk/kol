...
[InlineKeyboardButton("صاحب السورس 🧑‍✈️", url=f"https://t.me/L_HLN")],
[InlineKeyboardButton("طريقة التشغيل 🧠", callback_data="bcmds"),InlineKeyboardButton("طريقة التفعيل 🦸", callback_data="bhowtouse")],
[InlineKeyboardButton("جروب البوت 🤖", url=f"https://t.me/CBSupportX"),InlineKeyboardButton("قناه التحديثات 🐉", url=f"https://t.me/CBSOURCE")],
...
ᴘᴏᴡᴇʀᴇᴅ ʙʏ [{OWNER_NAME}]""",
        ...
        reply_markup=InlineKeyboardMarkup([
[InlineKeyboardButton("The owner of the source 🧑‍✈️", url=f"https://t.me/L_HLN")],
...
[InlineKeyboardButton("Bot Group 🤖", url=f"https://t.me/CBSupportX"),InlineKeyboardButton("Channel Updates 🐉", url=f"https://t.me/CBSOURCE")],
[InlineKeyboardButton(f"{devname}", user_id=f"{dev}")],
...
💡 ɪғ ʏᴏụ ʜᴀᴠᴇ ᴀ ғᴏʟʟᴏᴡ-ụᴘ ǫụᴇѕᴛɪᴏɴѕ ᴀʙᴏụᴛ ᴛʜɪѕ ʙᴏᴛ, ʏᴏụ ᴄᴀɴ ᴛᴇʟʟ ɪᴛ ᴏɴ ᴍʏ ѕụᴘᴘᴏʀᴛ ᴄʜᴀᴛ ʜᴇʀᴇ: @CBSupportX
